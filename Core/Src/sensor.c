...
GPIO_TypeDef *triggerPorts[2] = {Trigger0_GPIO_Port, Trigger1_GPIO_Port};
uint16_t triggerPins[2] = {Trigger0_Pin, Trigger1_Pin};
GPIO_TypeDef *echoPorts[2] = {Echo0_GPIO_Port, Echo1_GPIO_Port};
uint16_t echoPins[2] = {Echo0_Pin, Echo1_Pin};
